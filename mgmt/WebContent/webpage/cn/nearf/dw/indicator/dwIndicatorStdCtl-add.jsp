...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="dwIndicatorStdCtlController.do?doAdd" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					 <t:dictSelect id="stdType" field="stdType" type="list" onlyShowDefault="false" extendJson="{style:'width:150px'}"
											typeGroupCode="DWStdType" hasLabel="false"  title="标准化类型" datatype="*"></t:dictSelect>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="originalTable" name="originalTable" type="text" style="width: 150px" class="inputxt"  datatype="*">
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="originalColumn" name="originalColumn" type="text" style="width: 150px" class="inputxt"  datatype="*">
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="stdName" name="stdName" type="text" style="width: 150px" class="inputxt"  datatype="*">
							<span class="Validform_checktip"></span>
