...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="dwIndicatorCtlController.do?doAdd">
					<input id="id" name="id" type="hidden" value="${dwIndicatorCtlPage.id }">
					<input id="status" name="status" type="hidden" value="I">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="bizGroup" name="bizGroup" type="text" style="width: 150px" class="inputxt"datatype="*">
		...
		<tr>
			...
			<td class="value">
		     	 <input id="targetTable" name="targetTable" type="text" style="width: 150px" class="inputxt" datatype="*">
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					<t:dictSelect field="type" type="list" noNeedBlank="true"
						typeGroupCode="DWIndType"  hasLabel="false"  title="类型"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<t:dictSelect field="sourceType" type="list" noNeedBlank="false"
						typeGroupCode="DWSourceType"  hasLabel="false"  title="来源" extendJson="{style:'width:80px'}"></t:dictSelect>
			</td>
			<td align="right" width="100px">
			...
			<td class="value">
				<t:dictSelect field="loadType" type="list" noNeedBlank="false"
						typeGroupCode="DWSourceLoadType"  hasLabel="false"  title="数据源来源类型" extendJson="{style:'width:80px'}"></t:dictSelect>
			</td>
		</tr>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="sourcePath" name="sourcePath" type="text" style="width: 350px" class="inputxt" >
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="delimiter" name="delimiter" type="text" style="width: 150px" class="inputxt" maxlength="1" >
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="bizKey" name="bizKey" type="text" style="width: 150px" class="inputxt" >
				<span class="Validform_checktip"></span>
...
<%--		<tr>
			...
			<td class="value">
		     	 <input id="historyKeepDays" name="historyKeepDays" type="text" style="width: 150px" class="inputxt">
				<span class="Validform_checktip"></span>
...
<%--				 <t:tab href="dwIndicatorCtlController.do?dwIndicatorColumnCtlList&id=${dwIndicatorCtlPage.id}" icon="icon-search" title="指标明细" id="dwIndicatorColumnCtl"></t:tab>--%>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
				  ...
				  <td align="left">
					  	<input name="dwIndicatorSftpCtlList[#index#].indicatorId" maxlength="10" 
					  		type="text" class="inputxt"  style="width:200px;" datatype="*">
	...
	<tbody id="add_dwIndicatorColumnCtl_table_template">
		<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
				  <td align="left">
						<t:dictSelect field="dwIndicatorColumnCtlList[#index#].type" type="list"
									noNeedBlank="true" typeGroupCode="DWFileType" defaultVal="" hasLabel="false" title="字段类型" extendJson="{style:'width:80px'}"></t:dictSelect>     
					  <label class="Validform_label" style="display: none;">字段类型</label>
				  </td>
				  <td align="left">
					  	<select id="dwIndicatorColumnCtlList[#index#].fromSchema" name="dwIndicatorColumnCtlList[#index#].fromSchema" style="width: 120px;" onchange="onFactSchemaChange(#index#);onFromColumnSchemaChange(#index#)" datatype="*">
				  ...
				  <td align="left">
					  	<select id="dwIndicatorColumnCtlList[#index#].fromTable" name="dwIndicatorColumnCtlList[#index#].fromTable" style="width: 150px" onchange="onFromColumnSchemaChange(#index#)" datatype="*">
						</select>
						<span class="Validform_checktip"></span>	
					   <label class="Validform_label" style="display: none;">源表</label>
					</td>
				   <td align="left">
					  	<select id="dwIndicatorColumnCtlList[#index#].fromColumn" name="dwIndicatorColumnCtlList[#index#].fromColumn" style='width: 150px'" onchange="onFromColumnChange(#index#)" datatype="*">
						</select>
						<span class="Validform_checktip"></span>
					  <label class="Validform_label" style="display: none;">源字段</label>
					</td>
					<td align="left">
					  	<input name="dwIndicatorColumnCtlList[#index#].formula" maxlength="255" datatype="*" type="text" class="inputxt"  style="width:157px">
					...
					<td align="left">
					  	<input name="dwIndicatorColumnCtlList[#index#].indicatorColumn" maxlength="255"  type="text" class="inputxt"  style="width:100px;" datatype="*">
