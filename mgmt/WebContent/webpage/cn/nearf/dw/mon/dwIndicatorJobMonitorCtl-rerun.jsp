...
<html>
 ...
 <body>
	 <c:if test="${rerunError == 0}">
	     <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="dwIndicatorJobMonitorCtlController.do?doRerun&id=${dwIndicatorCtlPage.id}" tiptype="1">
