...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="userController.do?saveUser" beforeSubmit="setOrgIds">
	...
	<table style="width: 680px;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			<td align="right" nowrap><label class="Validform_label"> <t:mutiLang langKey="common.real.name"/>: </label></td>
			<td class="value" colspan="3">
		...
		<tr>
			...
			<td class="value" colspan="3" nowrap>
                ...
                <input name="roleName" class="inputxt" value="${roleName }" id="roleName" readonly="readonly" datatype="*" ignore="ignore" />
		...
		<tr>
			<td align="right" width="15%" nowrap><label class="Validform_label">  <t:mutiLang langKey="common.phone"/>: </label></td>
			...
			<td align="right" width="15%"><label class="Validform_label"> <t:mutiLang langKey="common.tel"/>: </label></td>
			<td class="value" width="35%">
