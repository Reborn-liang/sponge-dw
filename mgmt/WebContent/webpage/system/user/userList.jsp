...
<%--<t:dgFunOpt funname="setDptIds(id)" title="设置部门权限"></t:dgFunOpt>
 	<t:dgFunOpt funname="setStockroomIds(id)" title="设置仓库权限"></t:dgFunOpt>
	<t:dgFunOpt funname="setSupplierIds(id)" title="设置供应商权限"></t:dgFunOpt> --%>
...
<%-- 	<t:dgToolBar title="添加门店管理员" langArg="common.user" icon="icon-add" url="userController.do?goAddStoreMgr" funname="add"></t:dgToolBar> --%>
...
function setDptIds(userId) {
	gridname="userList";
	
	add("设置所辖部门", "erpUserPermissionController.do?gotoSetDpts&userId=" + userId, null, null);
}

function setStockroomIds(userId) {
	gridname="userList";
	
	add("设置所辖仓库", "erpUserPermissionController.do?gotoSetStockrooms&userId=" + userId, null, null);
}

function setSupplierIds(userId) {
	gridname="userList";
	
	add("设置所辖供应商", "erpUserPermissionController.do?gotoSetSuppliers&userId=" + userId, null, null);
}
