<%@page import="cn.nearf.ggz.config.ErpConfig"%>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%@include file="/context/mytags.jsp"%>
<!DOCTYPE html >
<html>
<head>
<title>Sponge数据管理平台</title>
<t:base type="jquery,easyui,tools,DatePicker,autocomplete"></t:base>
<link rel="shortcut icon" href="images/favicon.ico">
<link rel="stylesheet" href="plug-in/login/css/style.css" />
<style type="text/css">
a {
	color: Black;
            ...
            <tr style="height: 25px;" align="right">
                <td style="" colspan="2">
                    ...
                    <div style="float: left; line-height: 25px; margin-left: 70px;">
                        <span class="headerTxtColorName"><t:mutiLang langKey="common.user"/>:</span>
                        <span class="headerTxtColorValue">${userName }</span>&nbsp;&nbsp;&nbsp;&nbsp;
                        <span class="headerTxtColorName"><t:mutiLang langKey="current.org"/>:</span>
                        <span class="headerTxtColorValue">${currentOrgName }</span>&nbsp;&nbsp;&nbsp;&nbsp;
                        <span class="headerTxtColorName"><t:mutiLang langKey="common.role"/>:</span>
                        <span class="headerTxtColorValue">${roleName }</span>
                    </div>
