...
function setapprole(id,roleName) {
	add("设置App菜单", "erpAppRoleFunctionController.do?multiSelAppFuns&appTag=app&roleId=" + id, null, null);	
}

function setpdarole(id,roleName) {
	add("设置pda菜单", "erpAppRoleFunctionController.do?multiSelAppFuns&appTag=pda&roleId=" + id, null, null);	
}
