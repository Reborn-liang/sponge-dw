...
public class TableSQLServerHandleImpl implements DbTableHandleI {
	...
	public String getMatchClassTypeByDataType(String dataType,int size, int digits) {
		String result ="";
	...
	private String getUpdateFieldDesc(ColumnMeta cgfromcolumnMeta,ColumnMeta datacolumnMeta) {
		...
		}else if(cgfromcolumnMeta.getColunmType().equalsIgnoreCase("long")){
			result = cgfromcolumnMeta.getColumnName()+" bigint"+" "+(cgfromcolumnMeta.getIsNullable().equals("Y")?"NULL":"NOT NULL");
	...
	private String getAddFieldDesc(ColumnMeta cgfromcolumnMeta) {
		...
		if(cgfromcolumnMeta.getColunmType().equalsIgnoreCase("string")){
			...
			result = cgfromcolumnMeta.getColumnName()+" bigint("+cgfromcolumnMeta.getColumnSize()+")"+" "+(cgfromcolumnMeta.getIsNullable().equals("Y")?"NULL":"NOT NULL");
		}else if(cgfromcolumnMeta.getColunmType().equalsIgnoreCase("double")){
