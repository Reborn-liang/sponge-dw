...
import org.jeecgframework.web.system.pojo.base.TSRoleAppFuns;
...
public class RoleController extends BaseController {
	 ...
	 * @return
	 */
	@RequestMapping(params = "saveAppRole")
	@ResponseBody
	public AjaxJson saveAppRole(HttpServletRequest request) {
		AjaxJson j = new AjaxJson();
		String roleId = request.getParameter("roleId");
		String appFuns = request.getParameter("appFuns");
		String appTag = request.getParameter("appTag");
		
		TSRoleAppFuns funs = systemService.findUniqueByProperty(TSRoleAppFuns.class, "roleId", roleId);
		if(funs == null) {
			funs = new TSRoleAppFuns();
		}
		funs.setRoleId(roleId);
		if("app".equals(appTag)) {
			funs.setAppFunIds(appFuns);
		}else {
			funs.setPdaFunIds(appFuns);
		}
		
		systemService.saveOrUpdate(funs);
