...
public class BaseController {
	...
	public String retrieveRealName() {
		...
		if(currLoginUser != null){
			String name = currLoginUser.getRealName();
			return name;
		}
		return "";
	}
	...
	public String retrievePhone() {
		TSUser currLoginUser = ClientManager.getInstance().getClient(ContextHolderUtils.getSession().getId()).getUser();
		if(currLoginUser != null){
			String phone = currLoginUser.getMobilePhone();
			return phone;
		}
		return "";
	}
...
//				dateFormat, true));
     ...
     */
    protected static List<String> extractIdListByComma(String ids) {
