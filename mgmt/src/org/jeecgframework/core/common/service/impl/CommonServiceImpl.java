...
public class CommonServiceImpl implements CommonService {
	...
	public <T> T findUniqueByCriteriaQuery(final CriteriaQuery cq) {
	...
	public int excuteUpdateDelete(final String hql, final Object[] values) {
		return this.commonDao.excuteUpdateDelete(hql, values);
	}
}
