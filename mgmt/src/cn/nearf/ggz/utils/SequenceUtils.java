...
public class SequenceUtils {
	...
	protected static final int DefaultSequenceLength = 18;
...
//				seq.insert(rule + 1, lenStr);
			...
			if (lenDif > 0) {
				long subSeed = seed % ((long) Math.pow(10, lenDif));
	...
	private static String generateRandomNumberChar(final int length) {
