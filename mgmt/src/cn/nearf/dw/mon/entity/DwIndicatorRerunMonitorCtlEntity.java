 ...
 */
@Entity
@Table(name = "dw_indicator_rerun_monitor_ctl", schema = "")
@SuppressWarnings("serial")
public class DwIndicatorRerunMonitorCtlEntity implements java.io.Serializable {
	/**主键*/
	...
	/**刷新时间*/
	@Excel(name="刷新时间",format = "yyyy-MM-dd")
	...
	/**
	 *方法: 取得java.util.Date
	 *@return: java.util.Date  刷新时间
	 */
	@Column(name ="REFRESH_DATE",nullable=true)
	...
	/**
	 *方法: 设置java.util.Date
	 *@param: java.util.Date  刷新时间
	 */
	public void setRefreshDate(java.util.Date refreshDate){
		this.refreshDate = refreshDate;
	}
	/**
	 *方法: 取得java.lang.Integer
	 *@return: java.lang.Integer  处理数据量
	 */
